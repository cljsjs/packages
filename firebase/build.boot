(set-env!
  ...
  :dependencies '[[adzerk/bootlaces   "0.1.9" :scope "test"]
                  [cljsjs/boot-cljsjs "0.4.5" :scope "test"]])
...
(deftask package []
  (comp
    (download :url "https://github.com/firebase/firebase-bower/archive/v2.1.2.zip"
              ...
              :unzip true)
    (sift :move {#"firebase-bower-([\d\.]*)/firebase-debug.js" "cljsjs/development/firebase.inc.js"
                 #"firebase-bower-([\d\.]*)/firebase.js" "cljsjs/production/firebase.min.inc.js"})
    (sift :include #{#"^cljsjs"})
