...
(task-options!
 pom  {:project     'cljsjs/js-joda-locale_en-us
       :version     +version+
...
(deftask package []
  (comp
    ...
    (sift :move {#"^index\.js$" "cljsjs/js-joda-locale/development/js-joda-locale_en-us.inc.js"})
    
    (minify :in  "cljsjs/js-joda-locale/development/js-joda-locale_en-us.inc.js"
            :out "cljsjs/js-joda-locale/production/js-joda-locale_en-us.min.inc.js")
    (sift :include #{#"^cljsjs"})
    (deps-cljs 
      :no-externs true 
      :name "cljsjs.js-joda-locale_en-us" 
