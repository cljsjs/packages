...
(task-options!
  pom {:project 'cljsjs/datatables-responsive
       :version +version+
...
(deftask package []
  ...
  (comp
    (download :url (format "https://cdn.datatables.net/responsive/%s/js/dataTables.responsive.js" +lib-version+)
              :target "cljsjs/datatables/development/datatables-responsive.inc.js")
    (download :url (format "https://cdn.datatables.net/responsive/%s/css/responsive.dataTables.css" +lib-version+)
              :target "cljsjs/datatables/development/datatables-responsive.css")
    (download :url (format "https://cdn.datatables.net/responsive/%s/js/dataTables.responsive.min.js" +lib-version+)
              :target "cljsjs/datatables/production/datatables-responsive.min.inc.js")
    (download :url (format "https://cdn.datatables.net/responsive/%s/css/responsive.dataTables.min.css" +lib-version+)
              :target "cljsjs/datatables/production/datatables-responsive.min.css")

	(deps-cljs :name "cljsjs.datatables-responsive"
